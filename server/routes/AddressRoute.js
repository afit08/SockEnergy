...
router.post(
  ...
  IndexController.AddressController.createAddress,
);
router.get(
  '/',
  authJWT.ensureCustomer,
  IndexController.AddressController.showAddress,
);
router.get(
  '/detailAdddress/:id',
  authJWT.ensureCustomer,
  IndexController.AddressController.detailAddress,
);
router.post(
  '/editAddress/:id',
  IndexController.csrfController.validateCSRFToken,
  authJWT.ensureCustomer,
  IndexController.AddressController.updateAddress,
);
router.delete(
  '/deleteAddress/:id',
  authJWT.ensureCustomer,
  IndexController.AddressController.deleteAddress,
);
